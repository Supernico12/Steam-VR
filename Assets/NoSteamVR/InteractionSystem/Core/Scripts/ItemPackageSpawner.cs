...
namespace Valve.VR.InteractionSystem
{
	...
	public class ItemPackageSpawner : MonoBehaviour
	{
		...
		private void SpawnAndAttachObject( Hand hand, GrabTypes grabType )
		{
			...
			WeaponController weapon = hand.otherHand.GetComponentInChildren<WeaponController>();
			if(weapon !=null){
				itemPackage.itemPrefab  = magazines[(int)weapon.types];
			}else {itemPackage.itemPrefab  = magazines[0] ;}
